<?php
    ...
    $conn = mysqli_connect("localhost", "root", "", "webartikel");
    ...
    //     $file_artikel = $_REQUEST['file_artikel'];

    //     $sql = "UPDATE blog_data SET title = '$title', content = '$content', penulis = '$penulis', tanggal = '$tanggal', file_artikel = '$file_artikel' WHERE id = $id";
    //     mysqli_query($conn, $sql);
    ...
    //     if ($_FILES['file_artikel']['size'] > 0) {
    //         // Remove the old file
    //         $sql = "SELECT file_artikel FROM blog_data WHERE id = $id";
    //         $result = mysqli_query($conn, $sql);
    //         $row = mysqli_fetch_assoc($result);
    //         $old_file = $row['file_artikel'];
    ...
    //     } else {
    //         // Update the database record without changing the file_artikel column
